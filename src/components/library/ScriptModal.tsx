  ...
  const [formData, setFormData] = useState<ScriptCreateInput>(
    script
      ? {
          ...
          hook: script.hook,
          structureBreakdown: script.structureBreakdown,
          emotionDesign: script.emotionDesign,
          cta: script.cta,
          reusablePoints: script.reusablePoints,
          rewrittenVersion: script.rewrittenVersion,
          suggestedProduct: script.suggestedProduct,
          performanceRating: script.performanceRating,
          isRecommended: script.isRecommended,
          notes: script.notes,
          viewsCount: script.viewsCount,
        }
      : {
          brand: '',
          productType: '',
